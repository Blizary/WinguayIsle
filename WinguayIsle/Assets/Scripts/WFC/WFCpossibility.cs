...
public class WFCpossibility 
{
    ...
    {
        List<WFCScriptableOBJ> newPossibilites = new List<WFCScriptableOBJ>();// store the new available possibilies taking in concideration the given list of Scripatble obj
        Debug.Log("Tile : " + location + " mode used is : "+ _mode);
        Debug.Log("current number of possibilities: " + possibleWFC.Count);
        ...
        possibleWFC.Clear();
        Debug.Log("Tile : " + location + " after remove there are : " + possibleWFC.Count + " possibilities");
        ...
        Debug.Log("Tile : "+ location +" after combining there are : " + possibleWFC.Count + " possibilities");
    }
